...
import { placeBookingAPI } from "../utils/API";
import { APP_COLOR } from "../utils/constant";
import { router } from "expo-router";
import Step1 from "../(user)/product/step/Step1";
import Step2 from "../(user)/product/step/Step2";
import Step3 from "../(user)/product/step/Step3";
import Step4 from "../(user)/product/step/Step4";
